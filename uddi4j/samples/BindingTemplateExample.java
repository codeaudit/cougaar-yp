...
public class BindingTemplateExample {
    ...
    public void run() {
        ...
        try {
            ...
            // Name is the service name. ServiceKey must be "" to save a new service
            BindingTemplates bindingTemplates = new BindingTemplates();
            BusinessService businessService =
            		new BusinessService ("", config.getProperty("serviceName"),
                                         bindingTemplates);
            businessService.setBusinessKey ("");


            // Adding BindingTemplates to the Business Service
            ...
            bindingTemplate.setAccessPoint (new AccessPoint("www.uddi.org","http"));
