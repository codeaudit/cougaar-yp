...
version 1.7.1.a fixes a reported bug in 1.7.1 which prevented text table
operation.
version 1.7.1.b fixes the location of the /bin directory in 1.7.1.a and
includes the Database Manager extension files for the Zaurus platform.
