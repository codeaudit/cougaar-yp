...
public class GetTModelDetailService extends UDDIService
{
  ...
  {
    GetTModelDetail request = (GetTModelDetail)element;
    Vector keyVector = request.getTModelKeyStrings();
   ...
   *
   */
  private TModelDetail execute(Vector keyVector,DataStore dataStore)
    throws JUDDIException
  {
