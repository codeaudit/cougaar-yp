...
class FindBusinessByNameQuery
{
  ...
  private static Logger log = Logger.getLogger(FindBusinessByNameQuery.class);
   ...
   */
  public static Vector select(Vector names,Vector keysIn,SearchQualifiers qualifiers,Connection connection)
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      log.info("select from BUSINESS_ENTITY & BUSINESS_NAME tables:\n\n\t" + sql.toString() + "\n");
   ...
   *
   */
  private static void appendWhere(StringBuffer sql,Vector names,SearchQualifiers qualifiers)
  {
...
//    keysIn.add("3ef4772f-e04b-46ed-8065-c5a4e167b5ba");
    ...
    if (connection != null)
    {
      try
      {
        ...
        select(names,keysIn,new SearchQualifiers(null),connection);
