...
class TModelIdentifierTable
{
  ...
  private static Logger log = Logger.getLogger(TModelIdentifierTable.class);
  ...
  static
  {
    ...
    // build dropSQL
    dropSQL = "DROP TABLE TMODEL_IDENTIFIER";

    // build createSQL
    sql = new StringBuffer(150);
    sql.append("CREATE TABLE TMODEL_IDENTIFIER (");
    ...
    sql.append("PRIMARY KEY (TMODEL_KEY,IDENTIFIER_ID),");
  ...
  /**
   * Drop the TMODEL_IDENTIFIER table.
   */
  public static void drop(Connection connection)
  {
    System.out.print("DROP TABLE TMODEL_IDENTIFIER: ");
  ...
  /**
   * Create the TMODEL_IDENTIFIER table.
   */
  public static void create(Connection connection)
  {
    System.out.print("CREATE TABLE TMODEL_IDENTIFIER: ");
    Statement statement = null;
  ...
  /**
   * Insert new row into the TMODEL_IDENTIFIER table.<p>
   *
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      for (int identifierID=0; identifierID<listSize; identifierID++)
      {
        ...
        log.info("insert into TMODEL_IDENTIFIER table:\n\n\t" + insertSQL +
  ...
  /**
   * Select all rows from the TMODEL_IDENTIFIER table for a given TModelKey.<p>
   *
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      log.info("select from TMODEL_IDENTIFIER table:\n\n\t" + selectSQL +
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      log.info("delete from TMODEL_IDENTIFIER table:\n\n\t" + deleteSQL +
        "\n\t TMODEL_KEY=" + tModelKey.toString() + "\n");
  ...
  public static void test(Connection connection)
  {
    ...
    if (connection != null)
    {
      try
      {
        ...
        TModelIdentifierTable.insert(tModel.getTModelKey(),keyRefs,connection);
