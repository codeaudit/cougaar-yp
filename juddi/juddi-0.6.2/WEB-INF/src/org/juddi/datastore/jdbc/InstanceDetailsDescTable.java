...
class InstanceDetailsDescTable
{
  ...
  private static Logger log = Logger.getLogger(InstanceDetailsDescTable.class);
  ...
  static
  {
    ...
    // build dropSQL
    dropSQL = "DROP TABLE INSTANCE_DETAILS_DESCR";

    // build createSQL
    sql = new StringBuffer(150);
    sql.append("CREATE TABLE INSTANCE_DETAILS_DESCR (");
    sql.append("BINDING_KEY VARCHAR(41) NOT NULL,");
    sql.append("TMODEL_INSTANCE_INFO_ID INT NOT NULL,");
    sql.append("INSTANCE_DETAILS_DESCR_ID INT NOT NULL,");
    sql.append("LANG_CODE VARCHAR(2) NOT NULL,");
    sql.append("DESCR VARCHAR(255) NOT NULL,");
    sql.append("PRIMARY KEY (BINDING_KEY,TMODEL_INSTANCE_INFO_ID,INSTANCE_DETAILS_DESCR_ID),");
  ...
  /**
   * Drop the INSTANCE_DETAILS_DESCR table.
   */
  public static void drop(Connection connection)
  {
    System.out.print("DROP TABLE INSTANCE_DETAILS_DESCR: ");
  ...
  /**
   * Create the INSTANCE_DETAILS_DESCR table.
   */
  public static void create(Connection connection)
  {
    System.out.print("CREATE TABLE INSTANCE_DETAILS_DESCR: ");
    Statement statement = null;
  ...
  /**
   * Insert new row into the INSTANCE_DETAILS_DESCR table.<p>
   *
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      for (int descID=0; descID<listSize; descID++)
      {
        ...
        log.info("insert into INSTANCE_DETAILS_DESCR table:\n\n\t" + insertSQL +
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
     // create a statement to query with
      ...
      log.info("select from INSTANCE_DETAILS_DESCR table:\n\n\t" + selectSQL +
        "\n\t BINDING_KEY=" + bindingKey.toString() +
        "\n\t TMODEL_INSTANCE_INFO_ID=" + tModelInstanceInfoID + "\n");
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      log.info("delete from INSTANCE_DETAILS_DESCR table:\n\n\t" + deleteSQL +
        "\n\t BINDING_KEY=" + bindingKey.toString() + "\n");
