...
class FindBindingByTModelKeyQuery
{
   ...
   */
  public static Vector select(String serviceKey,TModelBag tModelBag,Vector keysIn,SearchQualifiers qualifiers,Connection connection)
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      log.info("select from BINDING_TEMPLATE & TMODEL_INSTANCE_INFO tables:\n\n\t" + sql.toString() + "\n");
   ...
   *
   */
  private static void appendWhere(StringBuffer sql,String serviceKey,TModelBag tModelBag,SearchQualifiers qualifiers)
  {
  ...
  public static void test(Connection connection)
  {
    ...
    if (connection != null)
    {
      try
      {
        ...
        select(serviceKey,tModelBag,keysIn,new SearchQualifiers(null),connection);
        select(serviceKey,tModelBag,null,new SearchQualifiers(null),connection);
