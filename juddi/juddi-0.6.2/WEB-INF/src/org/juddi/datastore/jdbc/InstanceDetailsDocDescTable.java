...
class InstanceDetailsDocDescTable
{
  ...
  static
  {
    ...
    sql.append("PRIMARY KEY (BINDING_KEY,TMODEL_INSTANCE_INFO_ID,INSTANCE_DETAILS_DOC_DESCR_ID),");
  ...
  public static void test(Connection connection)
  {
    ...
    if (connection != null)
    {
      try
      {
        ...
        InstanceDetailsDocDescTable.insert(bindingKey,infoID,descList,connection);

        // select the Collection of Description objects
        descList = InstanceDetailsDocDescTable.select(bindingKey,infoID,connection);
