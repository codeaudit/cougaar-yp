 ...
 * @version 0.6.2
 */
public class BusyException extends JUDDIException
{
  /**
   *
   */
  ...
  public BusyException(String msg)
  {
    ...
    errInfo.setErrCode(ResultCodes.E_BUSY_CODE);
    errInfo.setText(ResultCodes.E_BUSY_MSG);

    Result result = new Result();
    result.setErrno(ResultCodes.E_BUSY);
